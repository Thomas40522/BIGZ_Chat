...
<html lang="en">
    <head>
        ...
        <title>Respond Message <?php echo $respond['id'];?>_BIGZ chat</title>
    </head>
    <body>
        <header>
        <nav class="nav_bar">
        ...
        <div id = "respond">
            <span>Dear </span><span><?php echo $username?></span><span>,</span><br>
            <span></span><br>
            <span>Thank you for reporting that "</span><span><?php echo $issue;?></span><span>"</span><br>
            <span></span><br>
            <span id="content"><?php echo $message;?></span><br>
            <br>
            <span>Best regards,</span><br>
            <span></span><br>
            <span>BIGZ Web Development Club</span><br>
        </div>
