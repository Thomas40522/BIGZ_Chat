<?php
    ...
    $admins = ['thomas','cosmo','rust','jacky','christiana','richard'];
    $restrictedAdmins = ['jarvis','jack','david'];
    ...
    foreach($restrictedAdmins as $admin){
        if($username == $admin){
            $_SESSION['isAdmin'] = 1;
            header("Location: sensor_posts.php");
        }
