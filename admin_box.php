<?php
    ...
    $sql = "SELECT * FROM suggestions WHERE isRespond = 0";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="post">
            <span id="post">Unanswered Suggestion box: click here shift to answered suggestion box</span>
        </div>
        <?php
        ...
        ?>
        <div class="content">
            <a target="_blank" href="<?php echo 'admin_box_respond.php?id='.$suggestion['id'];?>" id="a_title">
            <div class="container">
            ...
            <div id="content">       
                <span id="text_content"><?php echo $suggestion['content']; ?></span>
            </div>
            <div id="name">
        ...
        <script src="js/admin_box.js"></script>
