...
<html lang="en">
    <head>
        ...
        <title>Billboard _BIGZ Chat</title>
    </head>
    <body>
        <header>
        <nav class="nav_bar">
        ...
        <div id = "content">The following are news of upcoming events in our school</div>
        <section>
            <div>Please contact us for putting your post onto this page</div>
            <div>email: zizhuo.liu11732@basisinternational-gz.com</div>
        </section>
        <li id = "posters">
            <ul><img src = "assests/poster1.jpg", width = "400px", height = "569px", alt = "first poster"></ul>
            <ul><img src = "assests/poster2n.jpg", width = "400px", height = "569px", alt = "second poster"></ul>
            <ul><img src = "assests/poster3.jpg", width = "400px", height = "569px", alt = "third poster"></ul>
            <!-- <ul><img src = "assests/poster4.jpg", width = "400px", height = "569px", alt = "third poster"></ul> -->
        </li>
